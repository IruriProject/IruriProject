...
public class EnterpriseController {
	...
	@GetMapping("/enterprise/enterprisepage")
	public ModelAndView enterprisepage(HttpSession session) {
		ModelAndView mview = new ModelAndView();

		String loginId = (String) session.getAttribute("loginId");

		mview.addObject("dto", service.findEnterdataById(loginId));
		mview.setViewName("/enterprise/enterprisepage");

		return mview;
	}

	@GetMapping("/enterprise/confirmpass")
	...
	@PostMapping("/enterprise/confirmpassAction")
