					...
					<div class="withbtn">
						...
						<div>
							<c:if
								...
								<button type="button" id="btnscrap" class="btn btn-info mt-2">공고
									스크랩</button>
							...
							<c:if
								...
								<button type="button" class="btn btn-info mt-2"
									onclick="location.href='/posting/update?p_num=${dto.p_num}'">수정</button>
								<button type="button" class="btn btn-info mt-2"
									onclick="location.href='confirmpw?p_num=${dto.p_num}'">삭제</button>
								<button type="button" class="btn btn-info mt-2"
									onclick="reloadAlert()">끌어올리기</button>
							</c:if>
							<button type="button" class="btn btn-info mt-2"
