   ...
   <div class="formbold-main-wrapper">
      <div class="formbold-form-wrapper">
               ...
               <div id="dllocal" class="searchArea"
                  ...
                  <ul id="ulGugun" class="inputWrap">
                     ...
                     <li><span class="input "> <input type="checkbox"
                           ...
                           onchange="localdisplay(this, '10','1010');"><label style="font-weight: 400; margin-left: 5px;"
       ...
       <table id="personality">
					...
					<span class="textCount" style="float: right"></span><br>
					<span class="textCount2" style="float: right"></span><br>
					<script type="text/javascript">
