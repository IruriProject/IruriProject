		...
		<div class="container-fluid pt-4 px-4">
			<div class="row g-4" style="border: 1px solid gray">
				...
				<div class="col-sm-12 col-md-6 col-xl-7 w-75">
					...
					<br>
					<div class="h-100 bg-light rounded p-4">
						<span class="gwansim" onclick="location.href='enterLike'">관심기업
							${countLikeEnter }</span> <span class="gwansim"
							onclick="location.href=''">관심직종</span> <span class="gwansim"
							onclick="location.href=''">관심공고</span> <span class="gwansim"
							onclick="location.href=''">관심근무지</span> <br>
					</div>
				</div>
			</div>
		</div>
